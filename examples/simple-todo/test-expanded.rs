...
#[macro_use]
extern crate std;
use crate::api::{add_todo, favicon, get_todo};
...
mod api {
    ...
    const _: () = {
        ...
        impl<'de> _serde::Deserialize<'de> for NewTodo {
                ...
                __D: _serde::Deserializer<'de>,
            {
                ...
                #[doc(hidden)]
                const FIELDS: &'static [&'static str] = &["title", "description"];
    ...
    const _: () = {
        ...
        impl apistos::ApiComponent for NewTodo {
            fn child_schemas(
                ...
                (String, apistos::reference_or::ReferenceOr<apistos::ApistosSchema>),
            > {
            ...
            > {
                let (name, schema) = {
                    ...
                    (schema_name, apistos::reference_or::ReferenceOr::Object(schema))
                };
    ...
    #[doc(hidden)]
    struct __openapi_get_todo;
    #[automatically_derived]
    impl apistos::PathItemDefinition for __openapi_get_todo {
        fn is_visible() -> bool {
            true
        }
        ...
        fn components(
            ...
            <[_]>::into_vec(#[rustc_box] ::alloc::boxed::Box::new([component_builder]))
        }
    }
    pub(crate) fn get_todo(
        todo_id: Path<Uuid>,
    ...
    > + apistos::PathItemDefinition {
        ...
        apistos::actix::ResponseWrapper {
            inner,
            path_item: __openapi_get_todo,
        }
    }
    #[expect(non_camel_case_types)]
    #[doc(hidden)]
    struct __openapi_add_todo;
    #[automatically_derived]
    impl apistos::PathItemDefinition for __openapi_add_todo {
        fn is_visible() -> bool {
            true
        }
        fn operation(oas_version: apistos::OpenApiVersion) -> apistos::paths::Operation {
            ...
            if let Some(responses) = <apistos::actix::ResponseWrapper<
                Box<
                    dyn std::future::Future<
                        Output = Result<CreatedJson<Todo>, Error>,
                    > + std::marker::Unpin,
                >,
                __openapi_add_todo,
            >>::responses(oas_version, None) {
    ...
    > + apistos::PathItemDefinition {
        ...
        apistos::actix::ResponseWrapper {
            inner,
            path_item: __openapi_add_todo,
        }
    }
    #[allow(non_camel_case_types, missing_docs)]
    pub struct favicon;
    impl ::actix_web::dev::HttpServiceFactory for favicon {
        fn register(self, __config: &mut actix_web::dev::AppService) {
            async fn favicon() -> actix_web::Result<impl Responder> {
                Ok(HttpResponse::Ok())
            }
            let __resource = ::actix_web::Resource::new("/favicon")
                .name("favicon")
