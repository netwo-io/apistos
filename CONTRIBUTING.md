...
- Provide project and platform versions (rust, actix, etc), depending on what seems relevant.
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible versions. If you are looking for support, you might want to check [this section](#i-have-a-question)).
