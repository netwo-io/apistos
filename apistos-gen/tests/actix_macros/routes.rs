...
use actix_web::{dev::{Service, ServiceRequest, ServiceResponse, Transform}, http::{
    self,
...
#[get(path = "/routes/test2")]
#[post(path = "/routes/test")]
...
#[routes]
#[get(path = "/routes/overlap/test")]
#[get(path = "/routes/overlap/{foo}")]
...
#[routes]
#[get(path = "/routes/overlap2/{foo}")]
#[get(path = "/routes/overlap2/test")]
...
#[get(path = "/test/guard", guard = "guard_module::guard")]
...
#[get(path = "/test/wrap", wrap = "ChangeStatusCode")]
