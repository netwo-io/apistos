...
fn api_type_derive() {
  ...
  let name_schema = <Name2 as ApiComponent>::schema(OpenApiVersion::OAS3_1);
  let name_child_schemas = <Name2 as ApiComponent>::child_schemas(OpenApiVersion::OAS3_1);
  assert!(name_schema.is_some());
  assert!(name_child_schemas.is_empty());
  let (schema_name, schema) = name_schema.expect("schema should be defined");
...
fn api_type_derive_with_generic_type_parameter() {
  ...
  let name_schema = <Name<String> as ApiComponent>::schema(OpenApiVersion::OAS3_1);
  let name_child_schemas = <Name<String> as ApiComponent>::child_schemas(OpenApiVersion::OAS3_1);
  assert!(name_schema.is_some());
  assert!(name_child_schemas.is_empty());
  let (schema_name, schema) = name_schema.expect("schema should be defined");
  assert_eq!(schema_name, "Name");
  ...
  let name_schema = <Name2<String> as ApiComponent>::schema(OpenApiVersion::OAS3_1);
  let name_child_schemas = <Name2<String> as ApiComponent>::child_schemas(OpenApiVersion::OAS3_1);
  assert!(name_schema.is_some());
  assert!(name_child_schemas.is_empty());
  let (schema_name, schema) = name_schema.expect("schema should be defined");
  assert_eq!(schema_name, "Name2");
