...
fn api_component_derive() {
  ...
  let error_schemas = <ErrorResponse as ApiErrorComponent>::schemas_by_status_code(OpenApiVersion::OAS3_1);
  let error_responses = <ErrorResponse as ApiErrorComponent>::error_responses(OpenApiVersion::OAS3_1);
