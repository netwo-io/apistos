# Apistos Swagger UI &emsp; [![Documentation]][docs.rs] [![Latest Version]][crates.io] [![Build Status]][build] [![Deps Status]][deps.rs]
...
apistos = { version = "=1.0.0-pre-release.11", feature = ["swagger-ui"] }
```
